      ...
      <aside className="w-64 bg-brand-green text-white hidden lg:flex flex-col p-6 space-y-8">
        ...
        <nav className="flex-grow space-y-2">
          {[
            ...
            <button 
              key={i} 
              className={`flex items-center gap-3 w-full p-3 rounded-xl transition-all ${item.active ? 'bg-white/10 text-brand-gold font-bold' : 'hover:bg-white/5 opacity-70 hover:opacity-100'}`}
            >
