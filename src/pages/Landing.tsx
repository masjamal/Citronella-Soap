...
const Navbar = () => (
  <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-brand-soft py-4 px-6 md:px-12">
    <div className="landing-container flex justify-between items-center text-brand-green">
      ...
      <div className="flex gap-4 items-center">
        <Link to="/login" className="flex items-center gap-1 text-sm font-bold bg-brand-soft px-4 py-2 rounded-full hover:bg-brand-green hover:text-white transition-all">
      ...
      <Section className="bg-brand-green text-white">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            { name: "Maya", city: "Surabaya", text: "Suka karena busanya lembut and nggak bikin kulit terasa ketarik." }
          ].map((testi, i) => (
            <motion.div 
              key={i}
              whileInView={{ opacity: 1, y: 0 }}
